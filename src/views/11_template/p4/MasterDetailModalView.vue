<template>
  <div class="mt-3">
    ...
    <vue-good-table :columns="columns" :rows="customers" v-on:cell-click="onCellClick"
      :sort-options="{
        enabled: true
      }"
      :pagination-options="{
    ...
    <button style="display: none" ref="btnModal" data-bs-toggle="modal" data-bs-target="#customerModal"></button>
