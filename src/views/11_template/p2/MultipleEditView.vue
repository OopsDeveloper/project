  ...
  <div class="mt-3">
    <div class="row gx-3 gy-2 align-items-center">
      ...
      <div class="col-auto">
        ...
        <button class="btn btn-success me-1" :disabled="selectedCustomers.length === 0" @click="doSave">Save</button>
        <button class="btn btn-danger" :disabled="selectedCustomers.length === 0" @click="doDelete">Delete</button>
      </div>
    </div>
    <table class="table table-bordered mt-2">
      ...
      <tr :key="customer.id" v-for="customer in customers">
        <td>
          <input type="checkbox" class="form-check-input" :value="customer.id" v-model="selectedCustomers"/>
        </td>
        <td>
