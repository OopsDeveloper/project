...
public class StudyMemberVO {
	...
	public String toString() {
		return "StudyMemberVO [joinId=" + joinId + ", joinPass=" + joinPass + ", joinName=" + joinName + ", joinEmail="
				+ joinEmail + ", joinBirth=" + joinBirth + ", joinRegistrationDate=" + joinRegistrationDate
				+ ", joinInterestsCode=" + joinInterestsCode + ", joinGender=" + joinGender + ", joinPhone=" + joinPhone
				+ ", joinApprovalStatus=" + joinApprovalStatus + ", joinApprovalKey=" + joinApprovalKey
				+ ", joinThumbImg=" + joinThumbImg + ", joinLeader=" + joinLeader + ", joinAdmin=" + joinAdmin
				+ ", joinTemp=" + joinTemp + ", joinDel=" + joinDel + "]";
	}
